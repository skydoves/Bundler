...
@JvmSynthetic
@InlineBundleDsl
inline fun <reified T : Any> Fragment.observeBundle(
  key: String,
  defaultValue: T
): Lazy<LiveData<T>> {
...
@JvmSynthetic
@InlineBundleDsl
inline fun <reified T : Any> Fragment.observeBundleArray(
  key: String,
...
@JvmSynthetic
@InlineBundleDsl
inline fun <reified T : Any> Fragment.observeBundleArrayList(
  key: String,
